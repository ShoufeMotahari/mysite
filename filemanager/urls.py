...
urlpatterns = [
    ...
    path('images/<int:pk>/delete-ajax/', views.image_delete_ajax, name='image_delete_ajax'),
    ...
    path('api/compression-stats/', views.compression_stats_api, name='compression_stats_api'),
]