# core/managers/email_manager.py
import logging
from abc import ABC, abstractmethod

from django.contrib.auth import get_user_model

# Update this import based on where your EmailTemplate model will be located
# If you're moving it to core.models, use:
from core.models import EmailTemplate
# If it stays in users app, use:
# from users.models import EmailTemplate

from core.services.email_service.email_service import get_email_service
