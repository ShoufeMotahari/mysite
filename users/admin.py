...
from filemanager.models import ImageUpload, ImageGallery
...
class AdminMessageAdmin(admin.ModelAdmin):
    ...
    def sender_display(self, obj):
        ...
        try:
            type_name = sender.get_user_type_display() if hasattr(sender, 'user_type') and sender.user_type else 'نامشخص'
