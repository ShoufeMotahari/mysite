...
class AdminMessageForm(forms.ModelForm):
    ...
    def clean_subject(self):
        ...
        if subject:
            ...
            if len(subject) > 200:
                raise forms.ValidationError('موضوع پیام نمی‌تواند بیش از 200 کاراکتر باشد.')
        return subject
    ...
    def clean_message(self):
        ...
        if message:
            ...
            if len(message) > 5000:
                raise forms.ValidationError('متن پیام نمی‌تواند بیش از 5000 کاراکتر باشد.')
        return message
...
class AdminMessageReplyForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts = {
            'reply_text': 'پاسخ خود را به پیام ارسالی بنویسید'
        }
    ...
    def clean_reply_text(self):
        ...
        if reply_text:
            ...
            if len(reply_text) > 2000:
                raise forms.ValidationError('متن پاسخ نمی‌تواند بیش از 2000 کاراکتر باشد.')
        return reply_text
